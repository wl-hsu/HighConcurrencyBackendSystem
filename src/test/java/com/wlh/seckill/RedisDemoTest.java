...
public class RedisDemoTest {
    ...
    public void revertStock() {
        String stock = redisService.getValue("stock:19");
        System.out.println("before rollback, total is" + stock);

        redisService.revertStock("stock:19");

        stock = redisService.getValue("stock:19");
        System.out.println("after rollback, total is" + stock);
    }
     ...
     * Test the result of acquiring locks under high concurrency
     */
    @Test
    ...
    /**
     * Test the result of acquiring a lock under concurrency and then releasing the lock immediately
     * Test the result of acquiring the lock under concurrency and then releasing the lock immediately
     */
    @Test
